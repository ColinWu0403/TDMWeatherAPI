...
def fetch_forecast_weather_data(city: str, days: str):
    """
...
def fetch_history_weather_data(city: str, dt: str):
    """
    Fetch forecast data for a given city from WeatherAPI.com.
    ...
    try:
        ...
        if "error" in data:
            # Handle WeatherAPI-specific error
            return {'error': f"{data['error']['code']}: {data['error']['message']}"}
