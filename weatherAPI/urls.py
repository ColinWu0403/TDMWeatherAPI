...
urlpatterns = [
    ...
    path('weather/history/<str:location>/', views.get_weather_current, name='get_weather_history'),
    path('weather/forecast/<str:location>/', views.get_weather_forecast, name='get_weather_forecast'),
